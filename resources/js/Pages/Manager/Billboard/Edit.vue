...
const form = useForm({
    title: props.billboard.title || '',
    button: props.billboard.button || '',
    url: props.billboard.url || '',
    icon: props.billboard.icon || '',
    color: props.billboard.color || 'gradient-dark-red',
})

function submit() {
    form.put(`/manager/presentation/${props.billboard.identifier}`)
}
    ...
    <ManagerLayout leftbar-active="design">
        <div class="w-full">
            <div class="flex items-center gap-4 mb-6">
                ...
                <h1 class="text-2xl font-bold">Modifier l'annonce</h1>
            </div>
